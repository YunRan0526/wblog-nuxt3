import 'file://E:/GitHub Pro/我的/wblog_nuxt3/node_modules/unenv/runtime/polyfill/fetch.node.mjs';
import { Server } from 'http';
import { tmpdir } from 'os';
import { join } from 'path';
import { mkdirSync } from 'fs';
import { parentPort, threadId } from 'worker_threads';
import { provider, isWindows } from 'file://E:/GitHub Pro/我的/wblog_nuxt3/node_modules/std-env/dist/index.mjs';
import { toEventHandler, defineEventHandler, handleCacheHeaders, createEvent, createApp, createRouter, lazyEventHandler, eventHandler, useQuery } from 'file://E:/GitHub Pro/我的/wblog_nuxt3/node_modules/h3/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://E:/GitHub Pro/我的/wblog_nuxt3/node_modules/ohmyfetch/dist/node.mjs';
import destr from 'file://E:/GitHub Pro/我的/wblog_nuxt3/node_modules/destr/dist/index.mjs';
import { createRouter as createRouter$1 } from 'file://E:/GitHub Pro/我的/wblog_nuxt3/node_modules/radix3/dist/index.mjs';
import { createCall, createFetch } from 'file://E:/GitHub Pro/我的/wblog_nuxt3/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://E:/GitHub Pro/我的/wblog_nuxt3/node_modules/hookable/dist/index.mjs';
import { hash } from 'file://E:/GitHub Pro/我的/wblog_nuxt3/node_modules/ohash/dist/index.mjs';
import { createStorage } from 'file://E:/GitHub Pro/我的/wblog_nuxt3/node_modules/unstorage/dist/index.mjs';
import _unstorage_drivers_fs from 'file://E:/GitHub Pro/我的/wblog_nuxt3/node_modules/unstorage/drivers/fs.mjs';
import { withQuery, joinURL } from 'file://E:/GitHub Pro/我的/wblog_nuxt3/node_modules/ufo/dist/index.mjs';
import { createRenderer } from 'file://E:/GitHub Pro/我的/wblog_nuxt3/node_modules/vue-bundle-renderer/dist/index.mjs';
import devalue from 'file://E:/GitHub Pro/我的/wblog_nuxt3/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { snakeCase } from 'file://E:/GitHub Pro/我的/wblog_nuxt3/node_modules/scule/dist/index.mjs';
import { createDefu } from 'file://E:/GitHub Pro/我的/wblog_nuxt3/node_modules/defu/dist/defu.mjs';
import htmlTemplate from 'file://E:/GitHub Pro/我的/wblog_nuxt3/nuxt-build/views/document.template.mjs';
import { renderToString as renderToString$2 } from 'file://E:/GitHub Pro/我的/wblog_nuxt3/node_modules/vue/server-renderer/index.mjs';

const _runtimeConfig = {app:{baseURL:"\u002F",buildAssetsDir:"\u002F_nuxt\u002F",cdnURL:""},nitro:{routes:{},envPrefix:"NUXT_"},public:{NODE_ENV:"development"}};
...
const serverAssets = [{"baseName":"server","dir":"E:/GitHub Pro/我的/wblog_nuxt3/server/assets"}];
...
storage.mount('root', _unstorage_drivers_fs({"driver":"fs","base":"E:/GitHub Pro/我的/wblog_nuxt3"}));
storage.mount('src', _unstorage_drivers_fs({"driver":"fs","base":"E:/GitHub Pro/我的/wblog_nuxt3/server"}));
storage.mount('build', _unstorage_drivers_fs({"driver":"fs","base":"E:/GitHub Pro/我的/wblog_nuxt3/nuxt-build"}));
storage.mount('cache', _unstorage_drivers_fs({"driver":"fs","base":"E:/GitHub Pro/我的/wblog_nuxt3/nuxt-build/cache"}));
...
const _f1948d = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _f1948d, lazy: true, method: undefined },
  { route: '/**', handler: _f1948d, lazy: true, method: undefined }
];
...
const getClientManifest = cachedImport(() => import('file://E:/GitHub Pro/我的/wblog_nuxt3/nuxt-build/dist/server/client.manifest.mjs'));
const getSSRApp = !process.env.NUXT_NO_SSR && cachedImport(() => import('file://E:/GitHub Pro/我的/wblog_nuxt3/nuxt-build/dist/server/server.mjs'));
