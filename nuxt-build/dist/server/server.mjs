...
import require$$0, { getCurrentInstance, reactive, isRef, ref, onBeforeMount, onUnmounted, onServerPrefetch, toRef, computed, defineComponent, h, resolveComponent, watchEffect, Suspense, Transition, useSSRContext, useCssVars, unref, mergeProps, onMounted, resolveDirective, withCtx, createVNode, toDisplayString as toDisplayString$1, onBeforeUnmount, shallowRef, createTextVNode, onErrorCaptured, createApp, openBlock, createBlock, Fragment as Fragment$1, renderList } from "vue";
import { joinURL, withBase, withQuery, hasProtocol } from "ufo";
import { ssrRenderAttrs, ssrRenderClass, ssrRenderStyle, ssrRenderAttr, ssrInterpolate, ssrRenderSlot, ssrRenderComponent, ssrGetDirectiveProps, ssrRenderList, ssrRenderSuspense } from "vue/server-renderer";
...
const metaConfig = { "globalMeta": { "charset": "utf-8", "viewport": "width=device-width, initial-scale=1", "meta": [{ "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "name": "description", "content": "\u5414\u5305C,\u5414\u5305c,\u5414\u5305\u7F51,\u535A\u5BA2,blog,vue3,nuxt3,a beautiful blog" }, { "name": "keywords", "content": "\u5414\u5305,\u5414\u5305C,YBW,yebaoc,yebaoc.com,www.yebaoc.com,yb,ybyb,yb0526,yebao0526" }, { "property": "og:type", "content": "website" }, { "property": "og:title", "content": "\u5414\u5305C" }, { "property": "og:site_name", "content": "yebaoc.com" }, { "property": "og:description", "content": "\u5414\u5305C,\u5414\u5305c,\u5414\u5305\u7F51,\u535A\u5BA2,blog,vue3,nuxt3,a beautiful blog" }, { "property": "og:locale", "content": "zh_CN" }], "link": [], "style": [], "script": [], "title": "\u5414\u5305C" }, "mixinKey": "created" };
const metaMixin = {
  [metaConfig.mixinKey]() {
    var _a;
    const instance = getCurrentInstance();
...
const _sfc_main$p = {
  ...
  setup(__props) {
    const props = __props;
    useCssVars((_ctx) => ({
      "214cb832": unref(smallSize),
      "685f7729": unref(normalSize)
    }));
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "CircleCloseButton" }, _attrs, _cssVars))} data-v-10783608><div data-v-10783608></div><div data-v-10783608></div></div>`);
    };
  }
};
...
_sfc_main$p.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/CircleCloseButton.vue");
  return _sfc_setup$p ? _sfc_setup$p(props, ctx) : void 0;
};
const __nuxt_component_0$5 = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["__scopeId", "data-v-10783608"]]);
const PageDecoration_vue_vue_type_style_index_0_scoped_true_lang = "";
const _sfc_main$o = {
  __ssrInlineRender: true,
  props: {
    title1: {
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_CircleCloseButton = __nuxt_component_0$5;
      const _cssVars = { style: {
        "a38ffc40": unref(scrollColor)
      } };
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "PageDecoration" }, _attrs, _cssVars))} data-v-e559d0ee><div class="decoration" data-v-e559d0ee></div><div class="pageBorder" data-v-e559d0ee></div><div class="moon_and_star" data-v-e559d0ee><div data-v-e559d0ee></div><div data-v-e559d0ee></div><div data-v-e559d0ee></div><div data-v-e559d0ee></div></div><div class="${ssrRenderClass({ page_content: true, "beautiful-scroll": true })}" data-v-e559d0ee><div style="${ssrRenderStyle({ "width": "100%", "display": "flex", "justify-content": "center" })}" data-v-e559d0ee><div class="page_title"${ssrRenderAttr("data-content", props.title1)} data-v-e559d0ee></div></div><div style="${ssrRenderStyle({ "width": "100%", "display": "flex", "justify-content": "center" })}" data-v-e559d0ee><div class="page_project" data-v-e559d0ee><span class="project_text" data-v-e559d0ee>${ssrInterpolate(props.title2)}</span></div></div><div style="${ssrRenderStyle({ "width": "100%", "display": "flex", "justify-content": "center" })}" data-v-e559d0ee><div class="flower_border_bottom section_title" data-v-e559d0ee><h1 data-v-e559d0ee>@YBW</h1></div></div>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      ssrRenderSlot(_ctx.$slots, "test", {
        test: "11",
        test2: "22"
      }, null, _push, _parent);
      _push(`</div>`);
      _push(ssrRenderComponent(_component_CircleCloseButton, { class: "btn" }, null, _parent));
      _push(`</div>`);
    };
  }
};
...
_sfc_main$o.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/PageDecoration.vue");
  return _sfc_setup$o ? _sfc_setup$o(props, ctx) : void 0;
};
const __nuxt_component_0$4 = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["__scopeId", "data-v-e559d0ee"]]);
const style = "";
const ArticleViewer_vue_vue_type_style_index_0_scoped_true_lang = "";
const meta$4 = void 0;
const YBIMG_vue_vue_type_style_index_0_scoped_true_lang = "";
const _sfc_main$n = {
  __ssrInlineRender: true,
  props: {
    src: {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "imgContainer" }, _attrs))} data-v-8d0d7500><span class="poster" data-v-8d0d7500><i class="el-icon-picture-outline" data-v-8d0d7500></i></span><img${ssrRenderAttr("src", getSrc(props.src))} data-v-8d0d7500></div>`);
    };
  }
};
...
_sfc_main$n.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/YBIMG.vue");
  return _sfc_setup$n ? _sfc_setup$n(props, ctx) : void 0;
};
const __nuxt_component_0$3 = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["__scopeId", "data-v-8d0d7500"]]);
const $dealtime = (date, showtime = false) => {
...
const DecorationBox_vue_vue_type_style_index_0_scoped_true_lang = "";
const _sfc_main$m = {
  __ssrInlineRender: true,
  props: {
    title: {
  ...
  setup(__props) {
    const props = __props;
    return (_ctx, _push, _parent, _attrs) => {
      const _component_YBIMG = __nuxt_component_0$3;
      const _directive_lazybox = resolveDirective("lazybox");
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "DecorationBox" }, _attrs))} data-v-48196d4c><div class="inner" data-v-48196d4c>`);
      _push(ssrRenderComponent(_component_YBIMG, mergeProps({
        class: "img",
        src: props.src
      }, ssrGetDirectiveProps(_ctx, _directive_lazybox)), null, _parent));
      _push(ssrRenderComponent(unref(ElPopover), {
        ...
        reference: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="title" data-v-48196d4c${_scopeId}>${ssrInterpolate(props.title)}</div>`);
          } else {
            return [
              createVNode("div", { class: "title" }, toDisplayString$1(props.title), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`<p class="description" data-v-48196d4c>${ssrInterpolate(props.description)}</p><div class="date" data-v-48196d4c>${ssrInterpolate(unref($dealtime)(props.date))}</div></div></div>`);
    };
  }
};
...
_sfc_main$m.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/DecorationBox.vue");
  return _sfc_setup$m ? _sfc_setup$m(props, ctx) : void 0;
};
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-48196d4c"]]);
...
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["ssrRender", _sfc_ssrRender$5], ["__scopeId", "data-v-932fb240"]]);
...
const Border = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["ssrRender", _sfc_ssrRender$4]]);
...
const StarAndMoon = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-0a35b7f3"]]);
...
const Logo = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__scopeId", "data-v-751cf8de"]]);
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-b77b3bba"]]);
const successIcon = buildAssetsURL("success.5db99fba.svg");
const infoIcon = buildAssetsURL("info.114b23ac.svg");
const errorIcon = buildAssetsURL("error.c43d0805.svg");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        style: [
          unref(visible) ? null : { display: "none" },
          unref(customStyle)
        ],
        class: {
          "yb-message": true,
          "yb-message-error": unref(isError),
          "yb-message-success": unref(isSuccess),
          "yb-message-info": unref(isInfo),
          "yb-message-warning": unref(isWarning)
        }
      }, _attrs))} data-v-50b1d354><img${ssrRenderAttr("src", unref(iconType)[__props.type])} class="${ssrRenderClass({ "yb-icon": true, "yb-icon-transform": unref(isSuccess) || unref(isInfo) })}" data-v-50b1d354><div class="yb-message-content" data-v-50b1d354>${ssrInterpolate(__props.message)}</div>`);
      if (__props.showClose) {
        _push(ssrRenderComponent(_component_CircleCloseButton, {
...
_sfc_main$g.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/MessageBox/index.vue");
...
const _sfc_main$f = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "myMenu" }, _attrs, _cssVars))} data-v-6f8599d8><div class="content" data-v-6f8599d8><span class="avatar_container" data-v-6f8599d8><img${ssrRenderAttr("src", _imports_0)} class="avatar" data-v-6f8599d8></span><div class="cen" data-v-6f8599d8><!--[-->`);
      ssrRenderList(props.menu, (item) => {
        _push(`<div class="item" data-v-6f8599d8><img${ssrRenderAttr("src", item.src)} class="icon" data-v-6f8599d8> ${ssrInterpolate(item.name)}</div>`);
      });
      _push(`<!--]--></div><div class="footer" data-v-6f8599d8><div class="colorList" data-v-6f8599d8><span style="${ssrRenderStyle({ "background-color": "#c45c66" })}" class="color" data-v-6f8599d8></span><span style="${ssrRenderStyle({ "background-color": "#c3ce5f" })}" class="color" data-v-6f8599d8></span><span style="${ssrRenderStyle({ "background-color": "#283c5f" })}" class="color" data-v-6f8599d8></span><span style="${ssrRenderStyle({ "background-color": "#4aa9a4" })}" class="color" data-v-6f8599d8></span></div></div></div></div>`);
    };
  }
};
...
const Menu = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-6f8599d8"]]);
const _sfc_main$e = {
  __ssrInlineRender: true,
  setup(__props) {
...
const _sfc_main$d = {
  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "menuPage" }, _attrs, _cssVars))} data-v-4cb0ab12><div class="plotBackground" data-v-4cb0ab12><div class="downItem" data-v-4cb0ab12></div><div class="downItem" data-v-4cb0ab12></div><div class="downItem" data-v-4cb0ab12></div><div class="downItem" data-v-4cb0ab12></div>`);
      if (currentSize.value >= 760) {
        _push(ssrRenderComponent(_sfc_main$e, null, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="menu" data-v-4cb0ab12>`);
      _push(ssrRenderComponent(_component_CircleCloseButton, { class: "btn" }, null, _parent));
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-4cb0ab12"]]);
...
const routes = [
  ...
  },
  {
    name: "ArticleViewer",
    path: "/ArticleViewer",
    file: "E:/GitHub Pro/\u6211\u7684/wblog_nuxt3/pages/ArticleViewer.vue",
    children: [],
    meta: meta$4,
    alias: (meta$4 == null ? void 0 : meta$4.alias) || [],
    component: () => Promise.resolve().then(function() {
      return ArticleViewer$1;
    })
  },
  {
    name: "Articles",
...
const directives_c2106c84 = defineNuxtPlugin((nuxtApp) => {
...
const Error404 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-7371678c"]]);
...
const Error500 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-5d1604e8"]]);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-295ac4dd"]]);
const _sfc_main$6 = {
  __ssrInlineRender: true,
  setup(__props) {
...
const AboutMe = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$2]]);
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    const initArticle = async () => {
      const { data, refresh } = await useFetch(`https://www.yebaoc.com/api/article/getArticle?id=${ArticleId.value}`);
      if (data) {
        if (data.value) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_PageDecoration = __nuxt_component_0$4;
      _push(ssrRenderComponent(_component_PageDecoration, mergeProps({
        title1: unref(comTitle),
        title2: "Article Deatils"
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="content" data-v-e4c55204${_scopeId}><div class="viewer-container" data-v-e4c55204${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "content" }, [
                createVNode("div", { class: "viewer-container" }, [
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/ArticleViewer.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const ArticleViewer = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-e4c55204"]]);
const ArticleViewer$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": ArticleViewer
}, Symbol.toStringTag, { value: "Module" }));
const _sfc_main$3 = {
  __ssrInlineRender: true,
  setup(__props) {
    ...
    const initList = async () => {
      var _a;
      const { data, refresh } = await useFetch("https://www.yebaoc.com/api/article/getAll");
      if (data) {
        if (data.value) {
          if (data.value.results)
            articles.value = (_a = data == null ? void 0 : data.value) == null ? void 0 : _a.results;
        }
      }
    };
    onMounted(() => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_PageDecoration = __nuxt_component_0$4;
      const _component_DecorationBox = __nuxt_component_1$1;
      _push(ssrRenderComponent(_component_PageDecoration, mergeProps({
        title1: "\u6211\u7684\u6587\u7AE0",
        title2: "My Articles"
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="content" data-v-30bb79ca${_scopeId}><!--[-->`);
            ssrRenderList(articles.value, (v) => {
              _push2(ssrRenderComponent(_component_DecorationBox, {
                style: { "z-index": "30" },
                key: v.id,
                title: v.title,
            ...
            return [
              createVNode("div", { class: "content" }, [
                (openBlock(true), createBlock(Fragment$1, null, renderList(articles.value, (v) => {
                  return openBlock(), createBlock(_component_DecorationBox, {
                    style: { "z-index": "30" },
                    key: v.id,
                    title: v.title,
                    description: v.description,
                    date: v.create_time,
                    src: `${v.poster}`,
                    onClick: ($event) => getDeatil(v)
                  }, null, 8, ["title", "description", "date", "src", "onClick"]);
                }), 128))
              ])
            ];
          }
...
const Articles = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-30bb79ca"]]);
